...
const languageList = ["ko", "en", "zh-CN", "zh-TW", "es", "fr", "vi", "th", "id", "한국어", "영어", "중국어간체", "중국어", "중국어번체", "스페인어", "프랑스어", "베트남어", "태국어", "인도네시아어", "korean", "english", "chinese"]
...
module.exports = {
    name: "papago",
    aliases: ["파파고", "앵무새", "vkvkrh", "dodanto", "ㅔ멤해"],
    category: "naver",
    usage: "{prefix}파파고 <시작언어> <번역언어> <메세지>",
