...
module.exports = {
    ...
    run: async (client, message, args, ops) => {
        ...
        const { html_url, description, created_at, owner, name, homepage, language, stargazers_count, license } = await fetch(`https://api.github.com/repos/${encodeURI(args[0])}/${encodeURI(args[1])}`).then(e => e.json());
